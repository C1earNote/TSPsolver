...
public class CityDistanceCalculator {
    ...
    public static void main(String[] args) {
        ...
        try {
            BufferedReader file = new BufferedReader(new FileReader("/home/tanishq/Documents/Java Code/TSP/OriginalData.txt"));
            BufferedWriter outputFile = new BufferedWriter(new FileWriter("/home/tanishq/Documents/Java Code/TSP/IntermediateFile.txt"));
            ...
            for (String city : cities) {
                searchAndWriteToFile("/home/tanishq/Documents/Java Code/TSP/OriginalData.txt", outputFile, city);
            }

            outputFile.close();
            file.close();

            BufferedReader nowFindDist = new BufferedReader(new FileReader("/home/tanishq/Documents/Java Code/TSP/IntermediateFile.txt"));
            BufferedWriter distanceStore = new BufferedWriter(new FileWriter("/home/tanishq/Documents/Java Code/TSP/FinalFile.txt"));
